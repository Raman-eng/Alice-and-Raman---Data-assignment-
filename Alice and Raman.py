...
# Plotting data for different variables 
sns.relplot(x='Datetime', y='Consump1 Rate (kg/h)', kind="line", data=df)
sns.lineplot(x='Datetime', y='Consump2 Rate  (kg/h)', color='red', data=df)

sns.relplot(x='Datetime', y='Eng1 Tot1 Mass (kg)', kind="line", data=df)
sns.lineplot(x='Datetime', y='Eng2 Tot1 Mass (kg)', color='red', data=df)

sns.relplot(x='Datetime', y='Eng1 Tot2 Mass (kg)', kind="line", data=df)
sns.lineplot(x='Datetime', y='Eng2 Tot2 Mass (kg)', color='red', data=df)

sns.relplot(x='Datetime', y='Gps Speed (kn)', kind="line", data=df)
sns.lineplot(x='Datetime', y='SpeedlogSpeed (kn)', color='red', data=df)

sns.relplot(x='Datetime', y='Power1 (kW)', kind="line", data=df)

sns.relplot(x='Datetime', y='Aux Power1 (kW)', kind="line", data=df)
